...
| 업로드 제작 + 다운로드 | O | O | 무료 |
| 17종 전체 수동 제작 | X | O | 무료 |
| 17종 자동 변형 (규칙 기반) | X | O | Phase 2: 무료 / Phase 3+: 3,000 Tint |
| 프로젝트 저장 / 재수정 | X | O | 무료 |
| AI 배경 제거 고도화 | X | O | 500 Tint (확정, Phase 3~) |
| AI 가장자리 보정 | X | O | 500 Tint (확정, Phase 3~) |
| AI 자동 크롭 | X | O | 500 Tint (확정, Phase 3~) |
| HiDPI 멀티사이즈 (64/128px) | X | O | 1,000 Tint (확정) |
| AI 커서 생성 | X | O | Phase 4에서 결정 |
| 마켓 구매 | X | O | Tint로 결제 |
| 마켓 판매 | X | Creator만 | — |
...
| Member → Tint 구매 | 무료 Tint로 AI 맛본 후 더 쓰고 싶다 | 중간 (₩4,900 첫 결제) |
